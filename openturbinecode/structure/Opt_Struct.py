...
class StructMDAOom(om.ExternalCodeComp):
    def setup(self):
        ...
        self.TacsFile =  self.path_to_root+"/controls/tacs_setup/DTU_10MW_RWT_blade3D_rotated_Single.bdf"
        # file check
    ...
    def compute(self, inputs, outputs):
        ...
        v_t9 = inputs['Thick9']
        # DV definition
        Thicks = np.array([v_t1,v_t2,v_t3,v_t4,v_t5,v_t6,v_t7,v_t8,v_t9]) 
        # setup solver
