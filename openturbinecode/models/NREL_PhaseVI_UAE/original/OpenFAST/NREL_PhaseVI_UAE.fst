...
---------------------- INPUT FILES ---------------------------------------------
"NREL_PhaseVI_UAE_ED.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"NREL_PhaseVI_UAE_BD.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"NREL_PhaseVI_UAE_BD.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"NREL_PhaseVI_UAE_BD.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"NREL_PhaseVI_UAE_IW.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"NREL_PhaseVI_UAE_AD15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"NREL_PhaseVI_UAE_SD.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
