...
setuptools.setup(
    ...
    extras_require={
        ...
        "gui": ["PyQt5", "pyqtgraph"],
        "meshing": ["PGL"],
        "controls": ["scp", "pandas","ROSCO_toolbox", "pyFAST"] # TODO: this stuff is pretty heavyweight, we should find a way to selectively install and use only te packages that we need at installation time, or have some "fake" placeholder modules
        # "low-fidelity": [],
    },
